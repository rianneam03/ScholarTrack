        ...
        <>
          <div className="navbar-links">
            <NavLink to="/" className={({ isActive }) => (isActive ? "active" : "")}>
              <div className="nav-icon-wrapper" style={{background: '#14B8A6'}}>
            ...
            <NavLink to="/programs" className={({ isActive }) => (isActive ? "active" : "")}>
              <div className="nav-icon-wrapper" style={{background: '#0D9488'}}>
            ...
            <NavLink to="/students" className={({ isActive }) => (isActive ? "active" : "")}>
              <div className="nav-icon-wrapper" style={{background: '#065F46'}}>
            ...
            <NavLink to="/attendance" className={({ isActive }) => (isActive ? "active" : "")}>
              <div className="nav-icon-wrapper" style={{background: '#D97706'}}>
            ...
            {(role === "admin" || role === "teacher") && (
              <NavLink to="/staff" className={({ isActive }) => (isActive ? "active" : "")}>
                <div className="nav-icon-wrapper" style={{background: '#6366F1'}}>
            ...
            {role === "admin" && (
              <NavLink to="/admin/settings" className={({ isActive }) => (isActive ? "active" : "")}>
                <div className="nav-icon-wrapper" style={{background: '#64748B'}}>
