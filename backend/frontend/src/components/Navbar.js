  ...
  return (
    <nav className={`navbar ${isCollapsed ? "collapsed" : ""}`}>
      ...
      <div className="navbar-brand">
        <img src={logo} alt="ScholarTrack Logo" className="navbar-logo" />
      ...
      {user ? (
        <>
          <div className="navbar-links">
            {/* Overview - Visible to EVERYONE as requested */}
            ...
            {role === "teacher" && (
              <NavLink to="/teacher-dashboard" className={({ isActive }) => (isActive ? "active" : "")}>
                <div className="nav-icon-wrapper">
                  <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="white" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M2 3h6a4 4 0 0 1 4 4v14a3 3 0 0 0-3-3H2z"/><path d="M22 3h-6a4 4 0 0 0-4 4v14a3 3 0 0 1 3-3h7z"/></svg>
                </div>
